/*  Erika Bailon
 *  Hw 4 - Projections (wporked off of hw3)
 *  Need views: Orthogonal, Perspective and First person
 *  NOT use the CSCIx229 library for this assignment.
 *  The scene should consist of several 3D solid objects.
 *  The program should allow the scene to be viewed from different viewpoints using the cursor keys or mouse
 *  The orthogonal and perspective projections should allow the entire scene to be viewed from an overhead view
 *  the view should be from the same vantage point
 *  The program should allow a third mode which provides for first person navigation using a perspective projection.  
 *  The cursor keys should allow theuser to traverse the scene.
 */
...
int main(int argc,char* argv[])
{
   ...
   glutCreateWindow("Erika Bailon Hw4");
   //  Set callbacks
